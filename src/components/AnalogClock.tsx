...
// Replace this with your ESP32 IP (printed in Serial Monitor)
...
  // 🧠 Poll ESP32 status periodically to stay synced
  useEffect(() => {
...
  // Visual-only timer (kept from your version)
  useEffect(() => {
...
          style={{
            backgroundColor:
              isRunning && !isPaused ? "#d97706" : "#6b1a1a",
          }}
        >
          {isRunning && !isPaused ? (
            <>
